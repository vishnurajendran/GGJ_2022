...
#pragma warning disable CS0246 // The type or namespace name 'Pentagon' could not be found (are you missing a using directive or an assembly reference?)
    [CustomPropertyDrawer(typeof(Pentagon))]
#pragma warning restore CS0246 // The type or namespace name 'Pentagon' could not be found (are you missing a using directive or an assembly reference?)
